...
function generateHTML() {
    ...
    <head>
        ...
        <style>
            ...
            .slides {
                ...
                margin: 0 auto;
                border-radius: 15px;
                aspect-ratio: 9 / 16; /* Ajustar a proporção para 9:16 */
                object-fit: cover;
            }
    ...
    document.getElementById('generated-link-container').innerHTML = `<a href="${url}" download="index.html">Clique aqui para baixar seu HTML</a>`;
}

function downloadHTML() {
    const link = document.querySelector('#generated-link-container a');
    if (link) {
        link.click();
    }
}
